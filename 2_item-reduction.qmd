...
Total number of responses is `{r} nrow(items_data)`
...
```{r, warning=FALSE}
p80 <- quantile(d$raw_data$`Duration (in seconds)`, 0.80, na.rm = TRUE)
p95 <- quantile(d$raw_data$`Duration (in seconds)`, 0.95, na.rm = TRUE)
